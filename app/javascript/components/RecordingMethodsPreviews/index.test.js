    ...
    describe("three boxes are checked in the final preview", () => {
      ...
      it('defaults to "my child"', () => {
        expect(recordingMethodsPreviews().text()).to.contain(
          "I understand that my childʼs activities"
        );
      });
      ...
      describe("able to give consent", () => {
        ...
        it('removes "my child"', () => {
          expect(recordingMethodsPreviews().text()).to.contain(
            "I understand that my activities"
          );
        });
      });
    });
      ...
      describe('changing the "other" value', () => {
        ...
        beforeEach(() => {
          ...
          recordingMethodsPreviews()
            ...
            .handleTextOrRadioChange({
              target: {
                name: "research_session[other_recording_method]",
        ...
        it("changes the value in the list", () => {
          expect(recordingMethodsPreviews()).to.contain(
            <output
              className="reactive-preview__highlight"
              data-field="other_recording_method"
            >
              a new other value
            </output>
          );
